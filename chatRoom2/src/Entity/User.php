...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addChat(Participantes $chat): static
    {
    ...
    public function removeChat(Participantes $chat): static
    {
    ...
    public function getParticipantes(): ?Participantes
    {
    ...
    public function setParticipantes(Participantes $participantes): static
    {
        ...
        if ($participantes->getUser() !== $this) {
            $participantes->setUser($this);
        }
